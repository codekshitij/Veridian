...
// No lanyardPNG, so use a solid color for the band
export default function Lanyard({ position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true, user }) {
  return (
...
function Band({ maxSpeed = 50, minSpeed = 0, user }) {
